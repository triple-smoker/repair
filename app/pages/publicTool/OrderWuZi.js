    ...
    return (
        <Content>
            <Row style={{borderBottomWidth:1,borderColor:'#dedede',paddingLeft:20,paddingTop:10,height:40,paddingRight:20}}>
                <Col style={{width:'70%'}}><Text style={{color:'#313131',fontSize:14}}>名称</Text></Col>
                <Col style={{width:'20%'}}><Text style={{color:'#313131',fontSize:14}}>数量</Text></Col>
                <Col style={{width:'10%'}}><Text style={{color:'#313131',fontSize:14}}>价格</Text></Col>
            </Row>
            ...
            <Row style={{borderBottomWidth:1,borderColor:'#dedede',paddingLeft:20,paddingTop:10,height:40,paddingRight:20}}>
                <Col style={{width:'85%'}}><Text style={{color:'#313131',fontSize:16}}>合计</Text></Col>
                <Col style={{width:'15%'}}><Text style={{color:'#e95b5b',fontSize:16}}>￥300</Text></Col>
            </Row>
        </Content>
    );
  }
